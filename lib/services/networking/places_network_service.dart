...
class PlacesNetworkService {
  ...
  var radius = 22000; // just over 9 miles radius

  Future<List<Result>> findRestaurants(String latitude,
      String longitude) async {
    String url =
        'https://maps.googleapis.com/maps/api/place/nearbysearch/json?'
        'location=$latitude,$longitude&radius=$radius&type=%20cafe%20point_of_interest&keyword=food&key=$key&rankby=prominence';
