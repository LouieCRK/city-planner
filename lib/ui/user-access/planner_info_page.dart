...
class PlannerInfoPage extends StatefulWidget {
  final Result place;
  PlannerInfoPage({required this.place});

  @override
  _PlannerInfoPageState createState() => _PlannerInfoPageState();
}

class _PlannerInfoPageState extends State<PlannerInfoPage> {
            ...
            Column(
              children: [
                ...
                FlatButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(PlannerMessages().removeFromPlanner());
                      PlacesService().removePlannedPlace(widget.place);
                      print('Remove from Planner button pressed...');
                      setState(() {
